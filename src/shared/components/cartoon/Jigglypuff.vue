  ...
  <div class="jigglypuff">
    <div class="jiggly puffed">
      <div class="jiggly-body-upper">
        <div class="jiggly-body" />
        <div class="jiggly-ear jiggly-ear-left" />
        <div class="jiggly-ear jiggly-ear-right" />
        <div class="jiggly-puff" />
        <div class="jiggly-face">
          <div class="jiggly-eye jiggly-eye-left">
            <div class="jiggly-eye-pupil" />
            <div class="jiggly-eye-lid" />
          </div>
          <div class="jiggly-eye jiggly-eye-right">
            <div class="jiggly-eye-pupil" />
            <div class="jiggly-eye-lid" />
          </div>
          <div class="jiggly-blush jiggly-blush-left" />
          <div class="jiggly-blush jiggly-blush-right" />
          <div class="jiggly-mouth">
            <div class="jiggly-mouth-singing" />
          </div>
        </div>
        <div class="jiggly-arm jiggly-arm-left">
          <div class="jiggly-marker" />
        </div>
        <div class="jiggly-arm-right-wrapper">
          <div class="jiggly-arm jiggly-arm-right" />
        </div>
      </div>
      <div class="jiggly-leg jiggly-leg-left" />
      <div class="jiggly-leg jiggly-leg-right" />
      <div class="jiggly-music-notes">
        <div class="jiggly-music-note jiggly-music-note-one" />
        <div class="jiggly-music-note jiggly-music-note-two" />
        <div class="jiggly-music-note jiggly-music-note-three" />
      </div>
    </div>
  </div>
</template>
